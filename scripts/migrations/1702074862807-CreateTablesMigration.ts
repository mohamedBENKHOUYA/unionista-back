...
export class CreateTablesMigration1702074862807 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."promotion_translation_locale_enum" AS ENUM('en', 'es', 'ar', 'fr')`);
        await queryRunner.query(`CREATE TABLE "promotion_translation" ("promotion_id" uuid NOT NULL, "locale" "public"."promotion_translation_locale_enum" NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, CONSTRAINT "PK_b9cfecf95380d11d2048b58c05c" PRIMARY KEY ("promotion_id", "locale"))`);
        await queryRunner.query(`CREATE TABLE "promotion" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "discount_rate" integer NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, CONSTRAINT "PK_fab3630e0789a2002f1cadb7d38" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."variation_translation_locale_enum" AS ENUM('en', 'es', 'ar', 'fr')`);
        await queryRunner.query(`CREATE TABLE "variation_translation" ("variation_id" uuid NOT NULL, "locale" "public"."variation_translation_locale_enum" NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_18e81ed487314c33b659ea38e0a" PRIMARY KEY ("variation_id", "locale"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."product_translation_locale_enum" AS ENUM('en', 'es', 'ar', 'fr')`);
        await queryRunner.query(`CREATE TABLE "product_translation" ("product_id" uuid NOT NULL, "locale" "public"."product_translation_locale_enum" NOT NULL, "name" character varying NOT NULL, "description" text, CONSTRAINT "PK_eab0f2d38f21f91384b13e5bd36" PRIMARY KEY ("product_id", "locale"))`);
        await queryRunner.query(`CREATE TABLE "product" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "image_path" character varying, "category_id" uuid NOT NULL, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."shipping_method_translation_locale_enum" AS ENUM('en', 'es', 'ar', 'fr')`);
        await queryRunner.query(`CREATE TABLE "shipping_method_translation" ("shipping_method_id" uuid NOT NULL, "locale" "public"."shipping_method_translation_locale_enum" NOT NULL, "name" character varying NOT NULL, "description" text, CONSTRAINT "PK_0f145a06f04ee9227bd86719d77" PRIMARY KEY ("shipping_method_id", "locale"))`);
        await queryRunner.query(`CREATE TABLE "shipping_method" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "price" integer NOT NULL, CONSTRAINT "PK_b9b0adfad3c6b99229c1e7d4865" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."order_status_translation_locale_enum" AS ENUM('en', 'es', 'ar', 'fr')`);
        await queryRunner.query(`CREATE TYPE "public"."order_status_translation_status_enum" AS ENUM('pending', 'fulfillment', 'shipped', 'completed', 'cancelled', 'declined', 'refunded', 'partially-refunded', 'disputed')`);
        await queryRunner.query(`CREATE TABLE "order_status_translation" ("order_status_id" uuid NOT NULL, "locale" "public"."order_status_translation_locale_enum" NOT NULL, "status" "public"."order_status_translation_status_enum" NOT NULL DEFAULT 'pending', CONSTRAINT "PK_01cdaf81944ebb6bb1fce60fd88" PRIMARY KEY ("order_status_id", "locale"))`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_type_translation" ADD CONSTRAINT "FK_f11cfcbcff043be8a20e24f49df" FOREIGN KEY ("payment_type_id") REFERENCES "payment_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "promotion_translation" ADD CONSTRAINT "FK_e32a0cf8972f00d04f13cdf5fa0" FOREIGN KEY ("promotion_id") REFERENCES "promotion"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "variation_translation" ADD CONSTRAINT "FK_c6e2b7aa6b9ad6273e4c5bd858e" FOREIGN KEY ("variation_id") REFERENCES "variation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product_category_translation" ADD CONSTRAINT "FK_11481c5514fdc05bcce54e54296" FOREIGN KEY ("product_category_id") REFERENCES "product_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "variation_option_translation" ADD CONSTRAINT "FK_7ee1dc1a755425b8ae8e9a320a0" FOREIGN KEY ("variation_option_id") REFERENCES "variation_option"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product_translation" ADD CONSTRAINT "FK_045befe4da0d3c207a981f4e88b" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "shipping_method_translation" ADD CONSTRAINT "FK_7672e89bbaa1fdb4e98b43198a9" FOREIGN KEY ("shipping_method_id") REFERENCES "shipping_method"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_status_translation" ADD CONSTRAINT "FK_42ced646211e605da80b4bf4032" FOREIGN KEY ("order_status_id") REFERENCES "order_status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "promotion_productcategory_relation" ADD CONSTRAINT "FK_7124e85a20182796b40934a08a4" FOREIGN KEY ("promotionId") REFERENCES "promotion"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "promotion_productcategory_relation" DROP CONSTRAINT "FK_7124e85a20182796b40934a08a4"`);
        ...
        await queryRunner.query(`ALTER TABLE "order_status_translation" DROP CONSTRAINT "FK_42ced646211e605da80b4bf4032"`);
        await queryRunner.query(`ALTER TABLE "shipping_method_translation" DROP CONSTRAINT "FK_7672e89bbaa1fdb4e98b43198a9"`);
        ...
        await queryRunner.query(`ALTER TABLE "product_translation" DROP CONSTRAINT "FK_045befe4da0d3c207a981f4e88b"`);
        ...
        await queryRunner.query(`ALTER TABLE "variation_option_translation" DROP CONSTRAINT "FK_7ee1dc1a755425b8ae8e9a320a0"`);
        await queryRunner.query(`ALTER TABLE "product_category" DROP CONSTRAINT "FK_da9613eb01460b9c388f70500c9"`);
        await queryRunner.query(`ALTER TABLE "product_category_translation" DROP CONSTRAINT "FK_11481c5514fdc05bcce54e54296"`);
        await queryRunner.query(`ALTER TABLE "variation" DROP CONSTRAINT "FK_034eb08de2d9c528bbe4023721a"`);
        await queryRunner.query(`ALTER TABLE "variation_translation" DROP CONSTRAINT "FK_c6e2b7aa6b9ad6273e4c5bd858e"`);
        await queryRunner.query(`ALTER TABLE "promotion_translation" DROP CONSTRAINT "FK_e32a0cf8972f00d04f13cdf5fa0"`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_type_translation" DROP CONSTRAINT "FK_f11cfcbcff043be8a20e24f49df"`);
        ...
        await queryRunner.query(`DROP TABLE "order_status_translation"`);
        await queryRunner.query(`DROP TYPE "public"."order_status_translation_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."order_status_translation_locale_enum"`);
        await queryRunner.query(`DROP TABLE "shipping_method"`);
        await queryRunner.query(`DROP TABLE "shipping_method_translation"`);
        await queryRunner.query(`DROP TYPE "public"."shipping_method_translation_locale_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."product_translation_locale_enum"`);
        ...
        await queryRunner.query(`DROP TABLE "variation_option_translation"`);
        await queryRunner.query(`DROP TYPE "public"."variation_option_translation_locale_enum"`);
        await queryRunner.query(`DROP TABLE "product_category"`);
        await queryRunner.query(`DROP TABLE "product_category_translation"`);
        await queryRunner.query(`DROP TYPE "public"."product_category_translation_locale_enum"`);
        await queryRunner.query(`DROP TABLE "variation"`);
        await queryRunner.query(`DROP TABLE "variation_translation"`);
        await queryRunner.query(`DROP TYPE "public"."variation_translation_locale_enum"`);
        await queryRunner.query(`DROP TABLE "promotion"`);
        await queryRunner.query(`DROP TABLE "promotion_translation"`);
        await queryRunner.query(`DROP TYPE "public"."promotion_translation_locale_enum"`);
